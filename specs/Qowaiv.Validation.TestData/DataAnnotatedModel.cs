...
public sealed class DataAnnotatedModel : IValidatableObject
{
    public static DataAnnotatedModel New(int count)
    {
...
public sealed class DataAnnotatedModelValidator : AbstractValidator<DataAnnotatedModel>
{
    public DataAnnotatedModelValidator()
    {
...
public sealed class ChildValdator : Qowaiv.Validation.Fluent.ModelValidator<DataAnnotatedModel.Child>
{
    ...
    private static bool AddUp(DataAnnotatedModel.Child child) => child.JustIgnore1 + child.JustIgnore2 + child.JustIgnore3 <= short.MaxValue;
}
