...
namespace Qowaiv.Validation.Messages {
    ...
    internal class ValidationMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Entity {0} with ID {1} could not be found..
        /// </summary>
        internal static string EntityNotFound_ForTypeAndId {
            get {
                return ResourceManager.GetString("EntityNotFound_ForTypeAndId", resourceCulture);
            }
        }
